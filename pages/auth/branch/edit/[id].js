...
import headleSubmit from "@/components/auth/branch/edit/headleSubmit";
      ...
      {currentUser ? (
        <Container>
          <Button
            sx={{ mb: 6 }}
            variant="contained"
            onClick={() => router.push("/auth/branch")}
          >
            ย้อนกลับ
          </Button>
                  ...
                  {file.length === 0 ? (
                    values.branch_image === "ไม่มี" ? (
                      <ImgStyled
                        ...
                        alt={`${process.env.NEXT_PUBLIC_DRIVE_SELECT_IMAGE}1skPG9BiQsyMkacMmNVnCZfeZ2-x_yK_c`}
                      />
                    ) : (
                      <ImgStyled
